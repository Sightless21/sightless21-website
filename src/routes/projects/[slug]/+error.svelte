...
<PageLayout
	description="Explore a compilation of my finest endeavors2 endeavors spanning Web Design and Development. In a dynamic digital landscape"
...
>
	<div class="flex h-screen w-full flex-col items-center justify-center p-4 text-center">
		<SpinningText class="text-foreground mb-10 sm:mb-20" children="Ora! • Ora! • ORA! • Ora!"
		></SpinningText>
		<h1
